...
export default function MouthToothItem({
  toothrow,
  img,
  isVerified,
  dispatch,
  ...
  // const [imageStateDispatch] = useImageMouthConfig();
  ...
  const handleVerify = async () => {
    /**@TODO Handle errors */
    const updatedAnnotationsList = [];
    for (const list of Object.values(annotationState.annotations)) {
      updatedAnnotationsList.push(
        ...list.filter((an) => an.tooth_id === toothrow.id)
      );
    }
