...
export default function LimitedTemplate() {
  const classes = useStyles();
    ...
    <div>
      ...
      <Container maxWidth={"lg"} className={classes.root}>
        ...
        <TabPanel value={value} index={0}>
          <IntroTab type="LIMITED_EVALUATION" value={value} setValue={setValue} />
        </TabPanel>
        ...
        <TabPanel value={value} index={3}>
          <Examination value={value} setValue={setValue} type="LIMITED_EVALUATION" />
        </TabPanel>
